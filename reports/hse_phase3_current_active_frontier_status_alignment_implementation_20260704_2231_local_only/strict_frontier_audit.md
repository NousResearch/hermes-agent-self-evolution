...
- current_active_frontier=`PHASE_3_STRICT_COMPLETE` phase=3
...
- phase3: strict_complete=true status=`STRICT_COMPLETE_CURRENT_ACTIVE` blockers=none
- phase4: strict_complete=false status=`NOT_STRICT_COMPLETE_BLOCKED_BY_PHASE3_OR_SCOPE` blockers=darwinian_evolver_cli_not_invoked_for_current_strict_gate, phase4_evidence_local_or_scaffold_not_current_strict_plan_verified
...
phase3_internal_frontier_alignment_closure_review_go_no_github_write_no_active_apply_no_deploy_no_official_claim
