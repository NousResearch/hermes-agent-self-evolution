...
4. **Expanded holdout decision:** decide whether the 45-case set plus the SessionDB-derived holdout is enough for Phase 2 closeout or whether a 100+ case held-out quality slice is needed before claiming Phase 2 complete.
