...
class EvolutionConfig:
    ...
    # LLM configuration
    optimizer_model: str = "openai/gpt-5.4-mini"  # Model for GEPA reflections
    eval_model: str = "openai/gpt-5.4-mini"  # Model for LLM-as-judge scoring
    judge_model: str = "openai/gpt-5.4-mini"  # Model for dataset generation
