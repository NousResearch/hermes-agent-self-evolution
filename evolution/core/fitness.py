"""Fitness score representation for evolved artifacts.

Multi-dimensional scoring with weighted composite.
"""
...
class FitnessScore:
    ...
    feedback: str = ""  # Textual feedback for mutation guidance
